...
insert into contact (FIRST_NAME, LAST_NAME, USER_NAME, PASSWORD, EMAIL, ROLE_ID, GROUP_ID) values ('Chukcha1', 'Chukcha1', 'chukcha1', 'pass3', 'chukcha1@mail.com', 3, 1);
insert into contact (FIRST_NAME, LAST_NAME, USER_NAME, PASSWORD, EMAIL, ROLE_ID, GROUP_ID) values ('Chukcha2', 'Chukcha2', 'chukcha2', 'pass4', 'chukcha2@mail.com', 3, 1);
...
insert into assignment (STUDENT_ID, TEACHER_ID, UNIT_TASK_ID, STATUS, MARK, ANSWER) values (3, 2, 1, 0, 0, '');
insert into assignment (STUDENT_ID, TEACHER_ID, UNIT_TASK_ID, STATUS, MARK, ANSWER) values (3, 2, 2, 0, 0, '');
insert into assignment (STUDENT_ID, TEACHER_ID, UNIT_TASK_ID, STATUS, MARK, ANSWER) values (3, 2, 3, 0, 0, '');
insert into assignment (STUDENT_ID, TEACHER_ID, UNIT_TASK_ID, STATUS, MARK, ANSWER) values (3, 2, 4, 0, 0, '');
insert into assignment (STUDENT_ID, TEACHER_ID, UNIT_TASK_ID, STATUS, MARK, ANSWER) values (3, 2, 5, 0, 0, '');
insert into assignment (STUDENT_ID, TEACHER_ID, UNIT_TASK_ID, STATUS, MARK, ANSWER) values (3, 2, 6, 0, 0, '');
insert into assignment (STUDENT_ID, TEACHER_ID, UNIT_TASK_ID, STATUS, MARK, ANSWER) values (3, 2, 7, 0, 0, '');
insert into assignment (STUDENT_ID, TEACHER_ID, UNIT_TASK_ID, STATUS, MARK, ANSWER) values (3, 2, 8, 0, 0, '');
insert into assignment (STUDENT_ID, TEACHER_ID, UNIT_TASK_ID, STATUS, MARK, ANSWER) values (3, 2, 9, 0, 0, '');

insert into assignment (STUDENT_ID, TEACHER_ID, UNIT_TASK_ID, STATUS, MARK, ANSWER) values (4, 2, 1, 0, 0, '');
insert into assignment (STUDENT_ID, TEACHER_ID, UNIT_TASK_ID, STATUS, MARK, ANSWER) values (4, 2, 2, 0, 0, '');
insert into assignment (STUDENT_ID, TEACHER_ID, UNIT_TASK_ID, STATUS, MARK, ANSWER) values (4, 2, 3, 0, 0, '');
insert into assignment (STUDENT_ID, TEACHER_ID, UNIT_TASK_ID, STATUS, MARK, ANSWER) values (4, 2, 4, 0, 0, '');