...
public class ContactServiceImplTest extends AbstractServiceImplTest {
    ...
    private Contact expectedAdminContact = new Contact("Eugene", "Krylov", "pass1", "ekrylov@teachhub.ru", new Role(
            "admin", "11111111"), new Group("admins"));

    private Contact expectedTeacherContact = new Contact("Elena", "Krylova", "pass2", "ekrylova@teachhub.ru", new Role(
            "teacher", "11110000"), new Group("teachers"));
